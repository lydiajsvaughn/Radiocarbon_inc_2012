...
plottheme2 <- plottheme + theme(axis.text.x = element_text(size=10))
...
ggsave("CO2fluxplot.png", path="plots", width = 6, height = 5, dpi = 300)
```
...
ggsave("C14diffplot.png", path="plots", width = 4, height = 3, dpi = 300)
