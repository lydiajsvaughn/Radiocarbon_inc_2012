...
legendtheme <- theme(legend.title = element_text(size=8)) +
...
ggsave("CombinedPlot.png", combo, path="plots", width = 6,height = 3,dpi = 300)
...
ggsave("CombinedPlotb.png", combob, path="plots", width = 6,height = 3,dpi = 300)
...
ggsave("CombinedPlotc.png", comboc, path="plots", width = 6,height = 3,dpi = 300)
...
ggsave("CombinedPlotd.png", combod, path="plots", width = 6,height = 6,dpi = 300)
