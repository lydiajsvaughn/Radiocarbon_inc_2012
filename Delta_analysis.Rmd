...
ggsave("CombinedPlot.png", combo, path="plots", width = 6,height = 3,dpi = 600)
...
ggsave("CombinedPlotb.png", combob, path="plots", width = 6,height = 3,dpi = 600)
...
ggsave("CombinedPlotc.png", comboc, path="plots", width = 6,height = 3,dpi = 600)
