...
legendtheme <- theme(legend.title = element_text(size=10)) +
...
```{r}
legendthemeb <- theme(legend.title = element_text(size=10)) +
  theme(legend.text = element_text(size=8)) +
...
ggsave("CombinedPlot.png", combo, path="plots", width = 8,height = 4,dpi = 300)
...
ggsave("CombinedPlotb.png", combob, path="plots", width = 8,height = 4,dpi = 300)
...
ggsave("CombinedPlotc.png", comboc, path="plots", width = 8,height = 4,dpi = 300)
