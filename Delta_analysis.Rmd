...
```{r}
#Turnover times = 50y and 5,000y
PoolsPlot_50_5000_final <- PoolsPlot_50_5000 + 
        plottheme + 
        legendtheme +
...
```{r}
p1 <- BulkPlot_final + ggtitle('a')
p2 <- PoolsPlot_50_5000_final + ggtitle('b')
combo <- grid.arrange(p1, p2, nrow=2, heights=c(6,6))
ggsave("CombinedPlot.png", combo, path="plots", width = 6,height = 11,dpi = 1200)

p3 <- BulkPlotb_final + ggtitle('a')
p4 <- PoolsPlotb_50_5000_final + ggtitle('b')
combob <- grid.arrange(p3, p4, nrow=2, heights=c(6,6))
ggsave("CombinedPlotb.png", combob, path="plots", width = 6,height = 11,dpi = 1200)

p5 <- PoolsPlot_50_5000_final + ggtitle('a')
p6 <- PoolsPlot_20_10000_final + ggtitle('b')
comboc <- grid.arrange(p5, p6, nrow=2, heights=c(6,6))
ggsave("CombinedPlotc.png", combob, path="plots", width = 6,height = 11,dpi = 1200)
